...
const Preloader = () => {
  ...
  return (
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center bg-[#030014] transition-all duration-1000 ease-in-out ${isExiting ? 'opacity-0 scale-110 pointer-events-none' : 'opacity-100 scale-100'}`}>
      {/* Cinematic Overlays */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(3,0,20,0.8)_100%)] pointer-events-none z-10"></div>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-blue-600/10 rounded-full blur-[80px] animate-pulse delay-700"></div>
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-40 h-40 flex items-center justify-center">
          ...
          <div className="relative w-16 h-16 flex items-center justify-center">
            <div className="absolute inset-0 bg-gradient-to-tr from-purple-500 to-blue-500 rounded-full blur-md opacity-50 animate-pulse"></div>
            <div className="relative w-12 h-12 bg-[#030014] rounded-full flex items-center justify-center border border-white/10 backdrop-blur-sm">
        ...
        <div className="mt-12 flex flex-col items-center gap-4">
          <div className="flex flex-col items-center">
            <h2 className="text-3xl font-black tracking-[0.4em] uppercase">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-white to-blue-400 bg-[length:200%_auto] animate-gradient-x">
                Portfoilo
              </span>
            </h2>
            <div className="h-0.5 w-12 bg-gradient-to-r from-purple-500 to-blue-500 mt-1 rounded-full animate-bounce"></div>
          </div>
