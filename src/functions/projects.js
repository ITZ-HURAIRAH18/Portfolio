...
,
    ...
    summary: 'Adilytics is a visually engaging and interactive sales dashboard built with Streamlit and Plotly to analyze Adidas sales data. It delivers actionable insights across retailers, time, and regions—ideal for business teams, analysts, and stakeholders needing real-time metrics.'
       ...
       {
    skill: 'WebSnap – PCB Content Scraper',
    tools: ['Python', 'Requests', 'BeautifulSoup', 'python-docx'],
    demo: ['GitHub'],
    link: [
        'https://github.com/ITZ-HURAIRAH18/WebSnap-Pakistan-Cricket-Board.git'
    ],
    stack: 'Data Analysis',
    summary: 'WebSnap-Pakistan Cricket Board is a Python-based web scraping tool that extracts content from the official PCB "About" page. Using Requests and BeautifulSoup, it parses structured paragraphs and compiles them into a Word document for offline reading, archival, or documentation.'
}
